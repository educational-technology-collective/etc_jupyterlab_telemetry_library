# etc_jupyterlab_telemetry_library
...
This extension is composed of a Python package named `etc_jupyterlab_telemetry_library`
for the server extension and a NPM package named `@educational-technology-collective/etc_jupyterlab_telemetry_library`
